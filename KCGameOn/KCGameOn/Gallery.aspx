<%@ Page Title=" "Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Gallery.aspx.cs" Inherits="KCGameOn.Gallery" %>
...
<%if (!String.IsNullOrEmpty(SessionVariables.UserName))
      {%>
<h2>Game Servers</h2><br />
	<form class="well form-inline">
	<p>These servers are given local IPs - Players outside the LAN will not be able to connect to these servers at any time.<br/></p>
<div class="UImenu">
    <div class="UImenuItem">
        ...
        Now, you can click the ~ key and open the console, type: connect 192.168.1.241:27015 and hit enter.<p><p>
	...
	<div class="UImenuItem">
        ...
        This will launch Minecraft 1.5.2 with all the mods needed for FTB unleashed - from this point go through the normal process. <p>
