        ...
        public static void sendBarcodes()
        {
            ...
            using (reader = cmd.ExecuteReader())
            {
                ...
                while (reader.Read())
                {
                    ...
                    body += "<br /><br />Thanks to our huge boost in numbers this year, our December 3rd event will take place at the KCI EXPO Center (not at Cerner).";
                    body += "<br /><br />The address is <a href=\"https://www.google.com/maps/place/KCI+Expo+Center/@39.3068645,-94.6837743,18\">11730 NW Ambassador Dr, Kansas City, MO 64153.</a>";
                    body += "<br /><br />All BYOC/casual console gamers will need to bring at minimum 25' ethernet cord and their own power strip, along with full gaming gear.  Console tournament setups will need a powerstrip, but won't be using ethernet.";
                    body += "<br /><br />";
                    body += "<br /><br /><a href=\"https://kcgameon.com/Tournament.aspx\">Go to the KCGameOn tournament page for the tournament sign ups, check back often as tournaments could be added/removed based on demand.</a>";
