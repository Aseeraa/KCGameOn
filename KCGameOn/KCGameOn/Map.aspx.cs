            ...
            if (!string.IsNullOrEmpty(paymentkey) && !paid)
            {
                ...
                using (reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        body += "<br /><br />This October 8th event is a collaboration event with Extra Life. A 25-hour marathon where you can stream, get in your hours or just game out - this is totally optional and there is no pressure to join/donate.";
