...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <form class="well form-inline" runat="server">
        ...
        <div class="UImenu">
                ...
                <div class="Content">
                    <div class="control-group" style="margin-left: 40px;">
                        ...
                        <div class="alert alert-error">
                            <asp:Literal ID="recoveryError" runat="server" />
                        </div>
                        <%} %>
                        <label class="control-label" for="RecoverEmail">
                            <h4>Email Address</h4>
                        </label>
                        <div class="controls">
            ...
            <div class="UImenuItem">
                ...
                <div class="Content">
                    <div class="control-group" style="margin-left: 40px;">
                        <p>To recover your username, enter the email address you used to create a KcGameOn account.</p>
                        <%if (recoveryErrorUsername.Text.CompareTo("") == 1)
                          { %>
                        <br />
                        <div class="alert alert-error">
                            <asp:Literal ID="recoveryErrorUsername" runat="server" />
                        </div>
                        <%} %>
                        <label class="control-label" for="RecoverEmail">
                            <h4>Email Address</h4>
                        ...
                        <div class="controls">
                            <input id="Text1" name="inputRecoveryEmail" class="inputRecoveryEmail" runat="server" placeholder="Email" type="text" onkeyup="RadioControl();" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <form class="well form-inline" runat="server">
        ...
        An email has been sent to your email address.  Please read that email, copy the code and paste it into "Verification Code" field.
                    <%if (recoveryError1.Text.CompareTo("") == 1)
                      { %>
        <div class="alert alert-error">
            <asp:Literal ID="recoveryError1" runat="server" />
        </div>
        <%} %>
        <div class="control-group">
            <label class="control-label" for="ResetCode">
    ...
    <%}
      ...
      { %>
    <div class="alert alert-info">
        Password Reset Tips and Info!
        <br />
        <li>Password reset successful.
            <br />
        </li>
        <li>Good Job, Now write this down.<br />
        </li>
        <li>Use KeePass next time to store your password<br />
        </li>
    </div>
    <%} %>
    <%} %>
